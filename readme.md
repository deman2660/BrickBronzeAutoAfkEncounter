...
### Optional: faster OCR
You can optionally replace the default English model with the fast model from:
https://github.com/tesseract-ocr/tessdata_fast

Copy eng.traineddata into:
...
This file must include all generations, including Gen 9.
